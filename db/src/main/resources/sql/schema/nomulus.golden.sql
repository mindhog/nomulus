...
--
-- Name: Domain_HostResource fk_domain_hostresource_host_valid; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Domain_HostResource"
    ADD CONSTRAINT fk_domain_hostresource_host_valid FOREIGN KEY (ns_host_v_keys) REFERENCES public."HostResource"(repo_id);


--
-- Name: Domain_HostResource fkfmi7bdink53swivs390m2btxg; Type: FK CONSTRAINT; Schema: public; Owner: -
--
